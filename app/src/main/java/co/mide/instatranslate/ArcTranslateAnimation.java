...
/**
 * https://gist.github.com/guohai/2293628
 * Created by +guohai on Apr 3, 2012.
 */
...
//        System.err.printf("time: %f, dx: %f\t dy: %f\n", interpolatedTime, dx, dy);
    ...
    public void initialize(int width, int height, int parentWidth,
        ...
        mControl = new PointF(Math.min(mToXDelta, mFromXDelta), Math.max(mToYDelta, mFromYDelta)); // How to choose the
